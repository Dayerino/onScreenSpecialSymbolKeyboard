...
HWND equalsButton = CreateWindowA("Button","=",WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON, 435,50,btnW,btnH,hwnd,(HMENU)16,window.hInstance,NULL);
...
//third row
HWND tabButton=CreateWindowA("Button","Tab",WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON, 15,85,btnW,btnH,hwnd,(HMENU)18,window.hInstance,NULL);
HWND poundButton = CreateWindowW(L"BUTTON",L"£",WS_CHILD| WS_VISIBLE | BS_PUSHBUTTON,50,85,btnW,btnH,hwnd,(HMENU)19,window.hInstance,NULL);
HWND dollarButton = CreateWindowW(L"Button",L"$",WS_CHILD|WS_VISIBLE|BS_PUSHBUTTON,85,85,btnW,btnH,hwnd,(HMENU)20,window.hInstance,NULL);
HWND caretButton = CreateWindowW(L"Button",L"^",WS_CHILD|WS_VISIBLE|BS_PUSHBUTTON,120,85,btnW,btnH,hwnd,(HMENU)21,window.hInstance,NULL);
HWND ùButton = CreateWindowW(L"Button",L"ù",WS_CHILD|WS_VISIBLE|BS_PUSHBUTTON,155,85,btnW,btnH,hwnd,(HMENU)22,window.hInstance,NULL); 
HWND starButton = CreateWindowA("Button","*",WS_CHILD|WS_VISIBLE|BS_PUSHBUTTON,190,85,btnW,btnH,hwnd,(HMENU)23,window.hInstance,NULL);
HWND ampersandButton = CreateWindowA("Button","&&",WS_CHILD |WS_VISIBLE |BS_PUSHBUTTON,225,85,btnW,btnH,hwnd,(HMENU)24,window.hInstance,NULL);
HWND smallerthanButton = CreateWindowA("Button","<",WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON, 260,85,btnW,btnH,hwnd,(HMENU)26,window.hInstance,NULL);
HWND biggerthanButton = CreateWindowA("Button",">",WS_CHILD |WS_VISIBLE |BS_PUSHBUTTON,295,85,btnW,btnH,hwnd,(HMENU)53,window.hInstance,NULL);
HWND semicolonButton = CreateWindowA("Button",";",WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON, 330,85,btnW,btnH,hwnd,(HMENU)28,window.hInstance,NULL);
HWND colonButton = CreateWindowA("Button",":",WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON, 365,85,btnW,btnH,hwnd,(HMENU)29,window.hInstance,NULL);
HWND exclamationButton = CreateWindowW(L"Button",L"!",WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON, 400,85,btnW,btnH,hwnd,(HMENU)30,window.hInstance,NULL);
HWND accentButton = CreateWindowW(L"Button",L"é",WS_CHILD |WS_VISIBLE |BS_PUSHBUTTON,435,85,btnW,btnH,hwnd,(HMENU)31,window.hInstance,NULL);
//fourth row
...
HWND doubleQuoteButton = CreateWindowA("Button","\"",WS_CHILD |WS_VISIBLE |BS_PUSHBUTTON,85,120,btnW,btnH,hwnd,(HMENU)33,window.hInstance,NULL);
HWND singleQuoteButton = CreateWindowA("Button","\'",WS_CHILD |WS_VISIBLE |BS_PUSHBUTTON,120,120,btnW,btnH,hwnd,(HMENU)34,window.hInstance,NULL);
HWND openingParenthesisButton = CreateWindowA("Button","(",WS_CHILD |WS_VISIBLE |BS_PUSHBUTTON,155,120,btnW,btnH,hwnd,(HMENU)35,window.hInstance,NULL);
HWND closingParenthesisButton = CreateWindowA("Button",")",WS_CHILD |WS_VISIBLE |BS_PUSHBUTTON,190,120,btnW,btnH,hwnd,(HMENU)41,window.hInstance,NULL);
HWND otheraccentButton = CreateWindowW(L"Button",L"è",WS_CHILD |WS_VISIBLE |BS_PUSHBUTTON,225,120,btnW,btnH,hwnd,(HMENU)37,window.hInstance,NULL);
HWND underScoreButton = CreateWindowA("Button","_",WS_CHILD |WS_VISIBLE |BS_PUSHBUTTON,260,120,btnW,btnH,hwnd,(HMENU)38,window.hInstance,NULL);
HWND çButton = CreateWindowW(L"Button",L"ç",WS_CHILD |WS_VISIBLE |BS_PUSHBUTTON,295,120,btnW,btnH,hwnd,(HMENU)39,window.hInstance,NULL);
HWND àButton = CreateWindowW(L"Button",L"à",WS_CHILD |WS_VISIBLE |BS_PUSHBUTTON,330,120,btnW,btnH,hwnd,(HMENU)40,window.hInstance,NULL);
HWND hyphonButton = CreateWindowA("Button","-",WS_CHILD |WS_VISIBLE |BS_PUSHBUTTON,365,120,btnW,btnH,hwnd,(HMENU)36,window.hInstance,NULL);
...
//fifth
HWND plusButton = CreateWindowA("Button","+",WS_CHILD |WS_VISIBLE |BS_PUSHBUTTON,15,155,btnW,btnH,hwnd,(HMENU)42,window.hInstance,NULL);
HWND tildeButton = CreateWindowA("Button","~",WS_CHILD |WS_VISIBLE |BS_PUSHBUTTON,50,155,btnW,btnH,hwnd,(HMENU)43,window.hInstance,NULL);
HWND hashTagButton = CreateWindowA("Button","#",WS_CHILD |WS_VISIBLE |BS_PUSHBUTTON,85,155,btnW,btnH,hwnd,(HMENU)44,window.hInstance,NULL);
HWND openingbracesButton = CreateWindowA("Button","{",WS_CHILD |WS_VISIBLE |BS_PUSHBUTTON,120,155,btnW,btnH,hwnd,(HMENU)45,window.hInstance,NULL);
HWND closingBraceButton = CreateWindowA("Button","}",WS_CHILD |WS_VISIBLE |BS_PUSHBUTTON,155,155,btnW,btnH,hwnd,(HMENU)51,window.hInstance,NULL);
HWND orButton = CreateWindowA("Button","|",WS_CHILD |WS_VISIBLE |BS_PUSHBUTTON,190,155,btnW,btnH,hwnd,(HMENU)47,window.hInstance,NULL);
HWND backTickButton = CreateWindowA("Button","`",WS_CHILD |WS_VISIBLE |BS_PUSHBUTTON,225,155,btnW,btnH,hwnd,(HMENU)48,window.hInstance,NULL);
HWND backSlashButton = CreateWindowA("Button","\\",WS_CHILD |WS_VISIBLE |BS_PUSHBUTTON,260,155,btnW,btnH,hwnd,(HMENU)49,window.hInstance,NULL);
HWND forwardSlashButton = CreateWindowA("Button","/",WS_CHILD |WS_VISIBLE |BS_PUSHBUTTON,295,155,btnW,btnH,hwnd,(HMENU)50,window.hInstance,NULL);
HWND openingbracketButton = CreateWindowA("Button","[",WS_CHILD |WS_VISIBLE |BS_PUSHBUTTON,330,155,btnW,btnH,hwnd,(HMENU)46,window.hInstance,NULL);
HWND closingBracketButton = CreateWindowA("Button","]",WS_CHILD |WS_VISIBLE |BS_PUSHBUTTON,365,155,btnW,btnH,hwnd,(HMENU)52,window.hInstance,NULL);
HWND commaButton = CreateWindowA("Button",",",WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON, 400,155,btnW,btnH,hwnd,(HMENU)27,window.hInstance,NULL);
HWND atButton = CreateWindowA("Button","@",WS_CHILD |WS_VISIBLE |BS_PUSHBUTTON,435,155,btnW,btnH,hwnd,(HMENU)54,window.hInstance,NULL);
//sixth
