...
LRESULT CALLBACK AnsiWndProc(HWND hWnd,UINT message, WPARAM wParam, LPARAM lParam){
    switch(message){
        ...
        case WM_COMMAND://checks for a button click
            if(LOWORD(wParam) == 1){BTNINPUT(0x41);}//esc
            if(LOWORD(wParam) == 2){BTNINPUT(0x41);}//f1
            if(LOWORD(wParam) == 3){BTNINPUT(0x41);}//f2
            if(LOWORD(wParam) == 4){BTNINPUT(0x41);}//f3
            if(LOWORD(wParam) == 5){BTNINPUT(0x41);}//f4
            if(LOWORD(wParam) == 6){BTNINPUT(0x41);}//f5
            if(LOWORD(wParam) == 7){BTNINPUT(0x41);}//f6
            if(LOWORD(wParam) == 8){BTNINPUT(0x41);}//f7
            if(LOWORD(wParam) == 9){BTNINPUT(0x41);}//f8
            if(LOWORD(wParam) == 10){BTNINPUT(0x41);}//f9
            if(LOWORD(wParam) == 11){BTNINPUT(0x41);}//f10
            if(LOWORD(wParam) == 12){BTNINPUT(0x41);}//f11
            if(LOWORD(wParam) == 13){BTNINPUT(0x41);}//f12
            if(LOWORD(wParam) == 14){BTNINPUT(0x41);}//²
            if(LOWORD(wParam) == 15){BTNINPUT(0x41);}//°
            if(LOWORD(wParam) == 16){BTNINPUT(0x41);}//=
            if(LOWORD(wParam) == 17){BTNINPUT(0x41);}//backspace
            if(LOWORD(wParam) == 18){BTNINPUT(0x41);}//tab
            if(LOWORD(wParam) == 19){BTNINPUT(0x41);}//£
            if(LOWORD(wParam) == 20){BTNINPUT(0x41);}//$
            if(LOWORD(wParam) == 21){BTNINPUT(0x41);}//^
            if(LOWORD(wParam) == 22){BTNINPUT(0x41);}//ù
            if(LOWORD(wParam) == 23){BTNINPUT(0x41);}//*
            if(LOWORD(wParam) == 24){BTNINPUT(0x41);}//&
            if(LOWORD(wParam) == 25){BTNINPUT(0x41);}//shift
            if(LOWORD(wParam) == 26){BTNINPUT(0x41);}//<
            if(LOWORD(wParam) == 27){BTNINPUT(0x41);}//,
            if(LOWORD(wParam) == 28){BTNINPUT(0x41);}//;
            if(LOWORD(wParam) == 29){BTNINPUT(0x41);}//:
            if(LOWORD(wParam) == 30){BTNINPUT(0x41);}//!
            if(LOWORD(wParam) == 31){BTNINPUT(0x41);}//é
            if(LOWORD(wParam) == 32){BTNINPUT(0x41);}//rshift
            if(LOWORD(wParam) == 33){BTNINPUT(0x41);}//""
            if(LOWORD(wParam) == 34){BTNINPUT(0x41);}//'
            if(LOWORD(wParam) == 35){BTNINPUT(0x41);}//(
            if(LOWORD(wParam) == 36){BTNINPUT(0x41);}//-
            if(LOWORD(wParam) == 37){BTNINPUT(0x41);}//è
            if(LOWORD(wParam) == 38){BTNINPUT(0x41);}//_
            if(LOWORD(wParam) == 39){BTNINPUT(0x41);}//ç
            if(LOWORD(wParam) == 40){BTNINPUT(0x41);}//à
            if(LOWORD(wParam) == 41){BTNINPUT(0x41);}//)
            if(LOWORD(wParam) == 42){BTNINPUT(0x41);}//+
            if(LOWORD(wParam) == 43){BTNINPUT(0x41);}//~
            if(LOWORD(wParam) == 44){BTNINPUT(0x41);}//#
            if(LOWORD(wParam) == 45){BTNINPUT(0x41);}//{
            if(LOWORD(wParam) == 46){BTNINPUT(0x41);}//[
            if(LOWORD(wParam) == 47){BTNINPUT(0x41);}//|
            if(LOWORD(wParam) == 48){BTNINPUT(0x41);}//`
            if(LOWORD(wParam) == 49){BTNINPUT(0x41);}//backslash
            if(LOWORD(wParam) == 50){BTNINPUT(0x41);}//forwardslash
            if(LOWORD(wParam) == 51){BTNINPUT(0x41);}//}
            if(LOWORD(wParam) == 52){BTNINPUT(0x41);}//]
            if(LOWORD(wParam) == 53){BTNINPUT(0x41);}//^
            if(LOWORD(wParam) == 54){BTNINPUT(0x41);}//@
            if(LOWORD(wParam) == 55){BTNINPUT(0x41);}//ctrl
            if(LOWORD(wParam) == 56){BTNINPUT(0x41);}//windows
            if(LOWORD(wParam) == 57){BTNINPUT(0x41);}//alt
            if(LOWORD(wParam) == 58){BTNINPUT(0x41);}//space
            if(LOWORD(wParam) == 59){BTNINPUT(0x41);}//ralt
            if(LOWORD(wParam) == 60){BTNINPUT(0x41);}//rwin
            if(LOWORD(wParam) == 61){BTNINPUT(0x41);}//rctrl
            if(LOWORD(wParam) == 62){BTNINPUT(0x41);}//up
            if(LOWORD(wParam) == 63){BTNINPUT(0x41);}//left
            if(LOWORD(wParam) == 64){BTNINPUT(0x41);}//down
            if(LOWORD(wParam) == 65){BTNINPUT(0x41);}//right
            if(LOWORD(wParam) == 66){BTNINPUT(0x41);}//enter
            if(LOWORD(wParam) == 67){BTNINPUT(0x41);}//delete
            if(LOWORD(wParam) == 68){BTNINPUT(0x41);}//up
            if(LOWORD(wParam) == 69){BTNINPUT(0x41);}//down
...
//second row
HWND tildeButton = CreateWindowW(L"Button",L"²",WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON, 15,50,30,30,hwnd,(HMENU)14,window.hInstance,NULL);
...
HWND shiftButton = CreateWindowA("Button","Shift",WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON, 400,120,65,30,hwnd,(HMENU)25,window.hInstance,NULL);
HWND compareButton = CreateWindowA("Button","<",WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON, 260,85,30,30,hwnd,(HMENU)26,window.hInstance,NULL);
HWND commaButton = CreateWindowA("Button",",",WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON, 295,85,30,30,hwnd,(HMENU)27,window.hInstance,NULL);
...
//
HWND RshiftButton = CreateWindowA("Button","Shift",WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON, 15,120,65,30,hwnd,(HMENU)32,window.hInstance,NULL);
...
HWND hyphonButton = CreateWindowA("Button","-",WS_CHILD |WS_VISIBLE |BS_PUSHBUTTON,190,120,30,30,hwnd,(HMENU)36,window.hInstance,NULL);
...
HWND closingParenthesisButton = CreateWindowA("Button",")",WS_CHILD |WS_VISIBLE |BS_PUSHBUTTON,365,120,30,30,hwnd,(HMENU)41,window.hInstance,NULL);
//
HWND plusButton = CreateWindowA("Button","+",WS_CHILD |WS_VISIBLE |BS_PUSHBUTTON,15,155,30,30,hwnd,(HMENU)42,window.hInstance,NULL);
HWND actualtildeButton = CreateWindowA("Button","~",WS_CHILD |WS_VISIBLE |BS_PUSHBUTTON,50,155,30,30,hwnd,(HMENU)43,window.hInstance,NULL);
...
HWND openingbracketButton = CreateWindowA("Button","[",WS_CHILD |WS_VISIBLE |BS_PUSHBUTTON,155,155,30,30,hwnd,(HMENU)46,window.hInstance,NULL);
...
HWND closingBraceButton = CreateWindowA("Button","}",WS_CHILD |WS_VISIBLE |BS_PUSHBUTTON,330,155,30,30,hwnd,(HMENU)51,window.hInstance,NULL);
...
HWND carettButton = CreateWindowA("Button","^",WS_CHILD |WS_VISIBLE |BS_PUSHBUTTON,400,155,30,30,hwnd,(HMENU)53,window.hInstance,NULL);
...
HWND Ctrl2Button = CreateWindowA("Button","Ctrl",WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON, 410,190,45,30,hwnd,(HMENU)61,window.hInstance,NULL);
//arrows keys
